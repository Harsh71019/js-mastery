...
export const Sidebar = (): React.JSX.Element => {
  ...
  return (
    <aside className="hidden md:flex fixed left-0 top-12 h-[calc(100vh-3rem)] w-60 bg-bg-primary/80 backdrop-blur-md border-r border-white/5 flex-col z-40">
      <div className="px-4 pt-6 pb-2">
         <div className="glass-panel rounded-xl p-4 flex flex-col gap-3 relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-1 relative z-10">
               <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-text-tertiary font-geist">Clearance_Level</span>
      ...
      <div className="px-5 py-6 flex flex-col gap-5 border-t border-white/5">
        {currentStreak > 0 && (
          <div className="flex flex-col gap-1">
            <span className="text-text-tertiary text-[10px] font-bold uppercase tracking-widest font-geist opacity-60">Uptime_Pulse</span>
        ...
        <div className="flex flex-col gap-1">
          <span className="text-text-tertiary text-[10px] font-bold uppercase tracking-widest font-geist opacity-60">Verification_Registry</span>
          <div className="flex items-center gap-2.5">
